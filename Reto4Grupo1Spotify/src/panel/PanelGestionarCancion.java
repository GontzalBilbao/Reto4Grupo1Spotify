...
//		setBackground(Color.DARK_GRAY);
		...
		panelCanciones.setBorder(new LineBorder(Color.black, 1, true));
		add(panelCanciones);

		JScrollPane spPanelCanciones = new JScrollPane(panelCanciones);
		spPanelCanciones.getVerticalScrollBar();
		spPanelCanciones.setBorder(null);
		spPanelCanciones.setSize(500, 425);
		spPanelCanciones.setLocation(30, 100);
		add(spPanelCanciones);
